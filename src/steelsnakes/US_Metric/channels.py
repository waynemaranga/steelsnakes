...
def C(designation: str) -> Channel:
    return cast(Channel, get_US_Metric_factory().create_section(designation, SectionType.C))

def MC(designation: str) -> MiscellaneousChannel:
    return cast(MiscellaneousChannel, get_US_Metric_factory().create_section(designation, SectionType.MC))

if __name__ == "__main__":
    print(C("C380X60").get_properties())
    print(MC("MC330X60").get_properties())
    print("🐬")