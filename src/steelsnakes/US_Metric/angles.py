...
from steelsnakes.US_Metric.factory import get_US_Metric_factory, USMetricSectionFactory
...
def L_EQUAL(designation: str) -> EqualAngle:
    ...
    return cast(EqualAngle, get_US_Metric_factory().create_section(designation, SectionType.L_EQUAL))

def L_UNEQUAL(designation: str) -> UnequalAngle:
    """Create an Unequal Angle section by designation."""
    return cast(UnequalAngle, get_US_Metric_factory().create_section(designation, SectionType.L_UNEQUAL))

def L2L_EQUAL(designation: str) -> BackToBackEqualAngle:
    """Create a Back-to-Back Equal Angle section by designation."""
    return cast(BackToBackEqualAngle, get_US_Metric_factory().create_section(designation, SectionType.L2L_EQUAL))
...
def L2L_LLBB(designation: str) -> LongLegBackToBackUnequalAngle:
    ...
    return cast(LongLegBackToBackUnequalAngle, get_US_Metric_factory().create_section(designation, SectionType.L2L_LLBB))
...
def L2L_SLBB(designation: str) -> ShortLegBackToBackUnequalAngle:
    ...
    return cast(ShortLegBackToBackUnequalAngle, get_US_Metric_factory().create_section(designation, SectionType.L2L_SLBB))
