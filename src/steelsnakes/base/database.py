...
class SectionDatabase(ABC):
    ...
    def _build_sqlite_from_json(self, db_path: Path, source_dir: Path) -> None:
        """Build SQLite database from JSON files using the sqlite_driver."""
        from steelsnakes.base.sqlite_driver import build_regional_sqlite_db
        
        # Use the existing comprehensive builder function
